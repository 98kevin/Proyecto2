...
<body>
		...
		<%@include file = "../encabezados/encabezado-suscriptor.html" %>
	      ...
	      ArrayList<Revista> revistas =  SqlConection.leerRevistas();
	...
	<c:forEach var="revista" items="${revistas}">
		<form name="formulario-suscripcion" action="controlador-suscripcion" method="post"> 
		    ...
		    <p><strong><span style="color: #196b8a;">Descripcion: </span></strong>"${revista.descripcion }"<strong><br>
		     ...
		     <input class="form-control" type="hidden" value="${revista.codigo}" name="codigo-revista"/>
		     <button type="submit" class="btn btn-primary">Ver</button> <br><br>
		      </form>
	</c:forEach>
